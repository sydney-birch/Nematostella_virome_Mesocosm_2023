...
5) Assemble viral transcriptome using Spades rnaviral - created: A) 24 collapsed replicate assemblies, B) 93 individual assemblies, and C) Total T0 and Total T96 assemblies & calculated normalized read count **(USED in Sharoni et. al., 2025 - *in review*)**
6) Analyze Function    
