...
def run_hisat2(input_dir,output_dir):
    ...
    for item in os.scandir():
        if "paired1" in item.name:
            ...
            #Run hisat2 
            result = subprocess.run("hisat2 -q -p 12 -x ../nr_db_index -1 filtered_unaligned_{0}_paired1.fq.gz -2 filtered_unaligned_{0}_paired2.fq.gz -S ../{1}/nr-filtered_{0}.sam".format(new_name, output_dir), shell=True)
